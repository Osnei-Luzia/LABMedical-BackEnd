...
INSERT INTO pacientes (contato_emergencia, convenio, endereco_id, numero_carteira, validade, id) VALUES ('(83) 2970-7661', 'Unimed', 1, '2312', '20/06/2033', 1);
INSERT INTO paciente_lista_cuidados (paciente_id, lista_cuidados) VALUES (1, 'Alergia 2, Alergia 4');
...
INSERT INTO consultas (id, data_hora, descricao, dosagens, medicacao, motivo, paciente_id_id, usuario_id_id) VALUES (default, '02/06/23 17:21:44,322000000', 'Descrição da consulta', 'Dosagens', 'Medicações', 'Motivo da Consulta', 1, 2);
INSERT INTO consultas (id, data_hora, descricao, dosagens, medicacao, motivo, paciente_id_id, usuario_id_id) VALUES (default, '22/05/23 22:12:54,432000000', 'Descrição da consulta', 'Dosagens', 'Medicações', 'Motivo da Consulta', 1, 2);
...
INSERT INTO exames (id, arquivo, data_hora, laboratorio, nome, paciente_id_id, resultado, tipo, usuario_id_id) VALUES (default, 'url/arquivo.pdf', '12/04/23 12:11:44,753000000', 'Laboratório 1', 'Nome do Exame', 1, 'Resultados de exame', 'Tipo de Exame', 2);
...
INSERT INTO exames (id, arquivo, data_hora, laboratorio, nome, paciente_id_id, resultado, tipo, usuario_id_id) VALUES (default, 'url/arquivo.pdf', '22/12/23 14:55:23,642000000', 'Laboratório 4', 'Nome do Exame', 1, 'Resultados de exame', 'Tipo de Exame', 2);
